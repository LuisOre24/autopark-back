...
import com.cibertec.autopark.service.RegistroParqueoService;
...
public class RegistroParqueoController {
    ...
    public ResponseEntity<List<RegistroParqueoDTO>> listarRegistroParqueos(){
        return   new ResponseEntity<>(registroParqueoService.listarRegistroParqueos(), HttpStatus.OK);
    }
    ...
    public ResponseEntity<RegistroParqueoDTO> obtenerRegistroParqueoPorId(@PathVariable("registroParqueoId") int registroParqueoId){
        return  new ResponseEntity<> ( registroParqueoService.obtenerRegistroParqueoPorId(registroParqueoId),HttpStatus.OK);
    }
    ...
    public ResponseEntity<RegistroParqueoDTO> registrarRegistroParqueo(@RequestBody RegistroParqueoCreateDTO registroParqueoCreateDTO){
        return  new ResponseEntity <>( registroParqueoService.registrarRegistroParqueo(registroParqueoCreateDTO) ,HttpStatus.OK) ;
    }
...
//    }
    ...
    public ResponseEntity<RegistroParqueoDTO> actualizarRegistroParqueo(@RequestBody RegistroParqueoUpdateDTO registroParqueoUpdateDTO){
        String rpta = registroParqueoService.salidaVehiculo(registroParqueoUpdateDTO);
